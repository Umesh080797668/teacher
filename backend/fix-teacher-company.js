// Fix script to add companyId to teacher
...
async function fixTeacherCompany() {
  try {
    ...
    if (!teacherId || !companyId) {
      console.log('\n=== Usage ===');
      console.log('node fix-teacher-company.js <teacherId> <companyId>');
      console.log('\nExample:');
      console.log('node fix-teacher-company.js TCH828985185 694009d60baf794f08d323ac');
      console.log('\n=== Current Teachers ===');
    ...
    if (hasCompany) {
      console.log('\n✓ Teacher already has this company');
    } else {
      // Add company
      teacher.companyIds.push(companyIdObj);
      await teacher.save();
      console.log('\n✓✓✓ SUCCESS: Company added to teacher');
